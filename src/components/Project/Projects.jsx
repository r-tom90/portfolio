...
const Projects = () => {
  return (
    <div className="dark:bg-gray-900">
      <div id="projects" className="m-auto max-w-[1040px] p-4 py-28 ">
        <h1 className="text-center text-4xl font-bold text-[#001b5e] dark:text-[#0097b2]">
          Projects
        </h1>
        <p className="py-5 text-center dark:text-stone-300">
          Here is a carefully curated selection of my front-end development
          work. These projects demonstrate my skill in various technologies and
          design principles. Each project has been crafted to deliver a visually
          pleasing and user-friendly experience. I hope they provide a good
          showcase of my abilities as a developer.
        </p>
